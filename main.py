...
temp = round(weather_now['main']['temp'],0)
feel_like = round(weather_now['main']['feels_like'],0)
min_temp = round(min([i['main']['temp_min'] for i in forecast['list']]), 0)
max_temp = round(max([i['main']['temp_max'] for i in forecast['list']]), 0)
