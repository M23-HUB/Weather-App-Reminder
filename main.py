...
weather_conditions = {
    'Clear':{'clear sky':{'active': False, 'label':(f'../images/01d.png')}},
    'Clouds':{'few clouds': {'active': False, 'label':(f'../images/02d.png')},
              'scattered clouds': {'active': False, 'label':(f'../images/03d.png')}, 
              'broken clouds': {'active': False, 'label':(f'../images/04d.png')}}, 
    'Drizzle':{'drizzle':{'active': False, 'label':(f'../images/09d.png')}}, 
    'Rain':{'rain':{'active': False, 'label':(f'../images/10d.png')}}, 
    'Thunderstorm':{'thunderstorm':{'active': False, 'label':(f'../images/11d.png')}}, 
    'Snow':{'snow':{'active': False, 'label':(f'../images/13d.png')}}, 
    'Atmosphere': {'atmosphere':{'active': False, 'label':(f'../images/50d.png')}}, 
}
